...
"""
This script organizes Sigma rules in folders by Mitre ATT&CK tactics and techniques.
The script use the dataset provided by https://github.com/mitre/cti .

Requirement is to have cloned the SigmaHQ repository as indicated in the README at section 'Downloading and Running' 
(https://github.com/WithSecureLabs/chainsaw#downloading-and-running).

For the correct usage the python must be loaded in the root folder of the project, togher with the Sigma repo clone.
"""

__author__ = "dan21san"
__credits__ = ["seansica"]
__version__ = "1.0.0"
__maintainer__ = "dan21san"
__status__ = "Test"
...
if __name__ == "__main__":
    ...
    # Organize the Sigma rules in folder by Tactics and/or Techniques
